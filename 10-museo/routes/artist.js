...
router.get('/profile/:id', verifyToken, artistController.profile);
...
router.post('/editArtist/:id', verifyToken, uploadFile("artists") ,artistController.editArtist)

//9.- borrado definitivo de un artista
router.get('/delDef/:artist_id', verifyToken, artistController.delDef);
